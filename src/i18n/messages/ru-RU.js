...
export default {
   [LOCALES.RUSSIAN]: {
      ...
      'dashboard.pdf-upload': 'Загрузите PDF файл',
      'dashboard.pdf-generate': 'Сегенрировать PDF с QR кодом',
      'dashboard.pdf-save': 'Сохранить PDF на сервер',
      'dashboard.pdf-style': 'Изменить стиль QR кода',
      'dashboard.pdf-clipboard': 'Скопировать имя PDF файла',
      'dashboard.pdf-clear': 'Сбросить и удалить PDF файл',

      'pdf.messages-nocerts': 'К сожалению, время активности сертификата истекло или он еще не загружен на сайт. Возможно, оно появится в ближайшем будущем. Спасибо.',
